...
const NavigationButtons = ({ 
  ...
  const handleNext = () => {
    ...
    if (currentStep === 4 && bookingDetails.schedule.type === 'scheduled' && !bookingDetails.schedule.date) {
      toast({
        title: "Date Required",
          ...
          <button 
            ...
            onClick={() => {
              toast({
                ...
                description: "A wizard will be summoned according to your preferences.",
              });
            }}
          >
            Summon a Wizard!
